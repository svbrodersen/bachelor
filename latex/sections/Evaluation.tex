...
\begin{table}
  ...
  \begin{center}
    ...
    increasing the size of STACK\_SIZE to 2048 bytes, THREAD\_STACK\_SIZE to
  8192 and GLOBAL\_STACK\_SIZE 10MB bytes it worked.} \\
    \raggedright{\footnotesize **This run was done with GLOBAL\_STACK\_SIZE of
    0x21480 bytes, THREAD\_STACK\_SIZE 0x14080 bytes and STACK\_SIZE of 2048
  bytes.} \\
  \raggedright{For more information behind picking the different stack sizes see
  Appendix~\ref{ap:stack}}
  \end{center}
\end{table}
